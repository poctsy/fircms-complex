...
<div id="yiiWebDebugToolbar" onmouseover="yiiDebugMouse(true);" onmouseout="yiiDebugMouse(false);">
	...
	<ul id="yiiWebDebugToolbarItems">
               <li>[&nbsp;
                   <a href="<?php echo Yii::app()->request->baseUrl;  ?>" class="yiiLinkItem"><?php echo Yii::t('build', 'FrontendSite');?></a>			&nbsp;]
		</li>
                <li>[&nbsp;
                    <a href="<?php echo Yii::app()->request->baseUrl.'/admin.php?r=' ; ?>" class="yiiLinkItem"><?php echo Yii::t('build', 'BackendSite');?></a>			&nbsp;]
		</li>
                    <li>[&nbsp;
                   <a href="<?php echo Yii::app()->request->baseUrl.'/index.php?r=gii';  ?>" class="yiiLinkItem"><?php echo Yii::t('build', 'FrontendGii');?></a>			&nbsp;]
		</li>
                <li>[&nbsp;
                    <a href="<?php echo Yii::app()->request->baseUrl.'/admin.php?r=gii' ; ?>" class="yiiLinkItem"><?php echo Yii::t('build', 'BackendGii');?></a>			&nbsp;]
		</li>
                  <li>[&nbsp;
                    <a href="<?php echo Yii::app()->request->baseUrl.'/admin.php?r=rights' ; ?>" class="yiiLinkItem"><?php echo Yii::t('build', 'Rbac');?></a>			&nbsp;]
		</li>
