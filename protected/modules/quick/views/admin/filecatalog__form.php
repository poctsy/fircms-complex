...
<div class="form">
    ...
    <?php echo $form->hiddenField($model, 'plugin_id', array('value' =>Plugin::model()->find(array("condition"=>"en_name='file'"))->id)); ?>
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model, 'list_view', Fircms::getView("node",Yii::app()->params['filequick']->listprefix), array('style' => 'width:200px')); ?>
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model, 'content_view', Fircms::getView("plugin",Yii::app()->params['filequick']->prefix), array('style' => 'width:200px')); ?>
