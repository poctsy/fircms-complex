<?php
/* @var $this ImagesCatalogController */
/* @var $model ImagesCatalog */
...
<div class="form">
    ...
    <?php echo $form->hiddenField($model, 'plugin_id', array('value' =>Plugin::model()->find(array("condition"=>"en_name='images'"))->id)); ?>
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model, 'list_view', Fircms::getView("node",Yii::app()->params['imagesquick']->listprefix), array('style' => 'width:200px')); ?>
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model, 'content_view', Fircms::getView("plugin",Yii::app()->params['imagesquick']->prefix), array('style' => 'width:200px')); ?>
