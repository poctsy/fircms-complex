...
class RightsModule extends CWebModule {
    ...
    public function init() {
        ...
        $this->setComponents(array(
            ...
            'frontendgenerator' => array(
                'class' => 'RFrontendGenerator',
            ),
            'backendgenerator' => array(
                'class' => 'RBackendGenerator',
            ),
        ));
   ...
   */
        public function getFrontendGenerator() {
        return $this->getComponent('frontendgenerator');
    }

    public function getBackendGenerator() {
        return $this->getComponent('backendgenerator');
    }
