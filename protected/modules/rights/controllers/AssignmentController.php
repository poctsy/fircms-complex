	...
	public function actionRevoke()
	{
		...
		if( Yii::app()->request->isPostRequest===true )
		{
			$itemName = $this->getItemName();
              //修改的地方,判断是否为创始人,不允许删除权限.
              ;
              if(User::model()->findByPk($_GET['id'])->username == Yii::app()->params['superAdminUse'] && $itemName == 'Admin')
              {
                  	Yii::app()->user->setFlash($this->module->flashSuccessKey,'创始人不允许去除权限');
