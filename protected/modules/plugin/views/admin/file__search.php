...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row select">
        <?php echo CHtml::dropDownList('searchDrownList', '1', array('0'=>$model->getAttributeLabel('base_catalog_name'),'1'=>$model->getAttributeLabel('base_title'),'2'=>$model->getAttributeLabel('file'),'3'=>$model->getAttributeLabel('content'))); ?>
    </div>
