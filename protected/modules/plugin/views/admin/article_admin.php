...
$('#Article_base_catalog_name').attr('value','').hide()
$('#Article_content').attr('value','').hide()

$('#searchDrownList').change(function(){
 val=$(this).children('option:selected').val()
 
$('#Article_base_catalog_name').hide()
$('#Article_base_title').attr('value','').hide()
$('#Article_content').attr('value','').hide()

if(val==0){ 
$('#Article_base_catalog_name').show()
}
if(val==1){ 
$('#Article_base_title').show()
}
if(val==2){ 
