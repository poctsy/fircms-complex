...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row select">
        <?php echo CHtml::dropDownList('searchDrownList', '1', array('0'=>$model->getAttributeLabel('catalog_name'),'1'=>$model->getAttributeLabel('title'),'2'=>$model->getAttributeLabel('content'))); ?>
    </div>
