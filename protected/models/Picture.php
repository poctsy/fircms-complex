 ...
 */
class Picture extends FActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('picture,content', 'filter', 'filter' => array($this, 'contentPurify')),
            ...
            array('base_catalog_id,base_id, picture', 'required'),
            array(' content', 'safe'),
            array('base_id', 'numerical', 'integerOnly' => true),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, base_id, picture, content,base_catalog_name,base_title', 'safe', 'on' => 'search'),
        );
    }
