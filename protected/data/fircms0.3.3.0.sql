...
CREATE TABLE IF NOT EXISTS `fircms_catalog` (
  ...
  `page_view` varchar(50) NOT NULL COMMENT '单页模板',
  PRIMARY KEY (`id`)
...
INSERT INTO `fircms_catalog` (`id`, `lft`, `rgt`, `level`, `name`, `thumb`, `title`, `keyword`, `description`, `type`, `navigation_id`, `plugin_id`, `url`, `content`, `list_view`, `content_view`, `page_view`) VALUES
(409, 1, 14, 1, '顶级分类', NULL, '', '', '', 1, 0, 1, '', '', '', '', ''),
(410, 2, 7, 2, '111', '', '', '', '', 1, 0, 2, 'aa', '11', 'list_post', 'content_post', ''),
(411, 8, 13, 2, '2222', '', '', '', '', 1, 0, 2, 'cc', '222', 'list_post', 'content_post', ''),
(415, 3, 4, 3, '22', '', '', '', '', 1, 0, 2, 'bb', '', 'list_post', 'content_post', ''),
(416, 5, 6, 3, '2222', '', '', '', '', 1, 0, 2, '22', '', 'list_post', 'content_post', ''),
(420, 9, 12, 3, '555', '', '', '', '', 1, 0, 2, '55', '', 'list_post', 'content_post', ''),
(421, 10, 11, 4, '333', '', '', '', '', 1, 0, 2, '222', '', 'list_post', 'content_post', '');
